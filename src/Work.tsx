      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <RoleDiv>
            <BriefCaseIcon icon={faBriefcase} />
            <TextDiv>
              <WorkHeading3>STEM Program Coordinator</WorkHeading3>
        ...
        <Grid item xs={12} md={6}>
          <RoleDiv>
            <BriefCaseIcon icon={faBriefcase} />
            <TextDiv>
              <WorkHeading3>Software Engineering Intern</WorkHeading3>
              <EmployerParagraph>Target Corporation</EmployerParagraph>
        ...
        <Grid item xs={12} md={6}>
          <RoleDiv>
            <BriefCaseIcon icon={faBriefcase} />
            <TextDiv>
              <WorkHeading3>Software Development Intern</WorkHeading3>
        ...
        <Grid item xs={12} md={6}>
          <RoleDiv>
            <BriefCaseIcon icon={faBriefcase} />
            <TextDiv>
              <WorkHeading3>NDSU Capstone Project Consultant</WorkHeading3>
        ...
        <Grid item xs={12} md={6}>
          <RoleDiv>
            <BriefCaseIcon icon={faBriefcase} />
            <TextDiv>
              <WorkHeading3>Java Learning Assistant</WorkHeading3>
              <EmployerParagraph>
